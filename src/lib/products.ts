...
const C = {
  ...
  dorado: { id: 'dorado', name: { es: 'Dorado espejo', pt: 'Dourado espelhado' }, hex: '#B08843' },
...
const TANNERY = {
  ...
  espejo: { es: 'Cuero espejo · Toscana', pt: 'Couro espelhado · Toscana' },
...
const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    family: 'escarpin',
    category: 'mujer',
    kind: { es: 'Slingback de cuero espejo', pt: 'Slingback de couro espelhado' },
    pricePYG: 2750000,
    color: C.dorado,
    tannery: TANNERY.espejo,
    heelMm: 75,
    weightG: 265,
    badge: 'nuevo',
    featured: true,
    ...
    intro: {
      es: 'Cuero espejo dorado sobre taco embudo de 75, con lazo de cristal cosido a mano. La pieza de vitrina de la casa.',
      pt: 'Couro espelhado dourado sobre salto trombeta de 75, com laço de cristal costurado à mão. A peça de vitrine da casa.',
    },
    story: {
      es: 'El cuero espejo no se pinta: se lamina en caliente sobre napa, y una vez laminado no admite ni un pliegue mal hecho, así que el montado se juega en un solo intento. El taco embudo reparte el peso hacia adelante, que es la razón por la que un dorado de vitrina se puede usar de verdad. El lazo lleva cuarenta y un cristales engarzados a mano, uno por uno, sobre la pala ya montada.',
      pt: 'O couro espelhado não é pintado: é laminado a quente sobre napa, e depois de laminado não admite uma dobra malfeita, então a montagem se joga numa única tentativa. O salto trombeta empurra o peso para a frente, e é por isso que um dourado de vitrine dá para usar de verdade. O laço leva quarenta e um cristais cravados à mão, um por um, sobre a pala já montada.',
    },
  },
  {
    slug: 'nocturne',
